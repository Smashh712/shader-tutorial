...
void RenderScene()
{
	...
	FilePath += std::to_string(matWorld._11) + " ";
	FilePath += std::to_string(matWorld._12) + " ";
	FilePath += std::to_string(matWorld._13) + " ";
	FilePath += std::to_string(matWorld._14) + " \n";

	FilePath += std::to_string(matWorld._21) + " ";
	FilePath += std::to_string(matWorld._22) + " ";
	FilePath += std::to_string(matWorld._23) + " ";
	FilePath += std::to_string(matWorld._24) + " \n";

	FilePath += std::to_string(matWorld._31) + " ";
	FilePath += std::to_string(matWorld._32) + " ";
	FilePath += std::to_string(matWorld._33) + " ";
	FilePath += std::to_string(matWorld._34) + " \n";

	FilePath += std::to_string(matWorld._41) + " ";
	FilePath += std::to_string(matWorld._42) + " ";
	FilePath += std::to_string(matWorld._43) + " ";
	FilePath += std::to_string(matWorld._44) + " \n";
